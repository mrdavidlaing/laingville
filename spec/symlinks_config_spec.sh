...
When call parse_symlinks_from_yaml "$temp_dir/packages.yml" "arch"
...
When call parse_symlinks_from_yaml "$temp_dir/packages.yml" "wsl"
The output should include ".bashrc"
The output should include ".config/tmux"
...
When call parse_symlinks_from_yaml "$temp_dir/packages.yml" "windows"
...
When call parse_symlinks_from_yaml "$temp_dir/packages.yml" "macos"
The output should include ".bashrc|"
The output should include ".config/tmux|"
...
When call parse_symlinks_from_yaml "$temp_dir/packages.yml" "unknown"
...
It "handles missing packages.yml file"
When call parse_symlinks_from_yaml "/nonexistent/packages.yml" "arch"
